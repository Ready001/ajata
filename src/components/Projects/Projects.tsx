    ...
    <div className="whole-section">
      ...
      <div className="project-section" id="web-projects">
        ...
        <div className="project-card">
          <img
            ...
            src={process.env.PUBLIC_URL + "/project_imgs/coder_connect.webp"}
        ...
        <div className="project-card">
          <img
            className="project-img top-img"
            src={process.env.PUBLIC_URL + "/project_imgs/playback.webp"}
        ...
        <div className="project-card-left project-card">
          <div className="project-card-inner">
            <img
              ...
              src={process.env.PUBLIC_URL + "/project_imgs/uni_news.webp"}
        ...
        <div className="project-card">
          <img
            className="project-img top-img"
            src={process.env.PUBLIC_URL + "/project_imgs/personal.webp"}
            alt="This website"
          />
          <h4
            className="project-title linked-title"
      ...
      <div className="project-section" id="ml-projects">
        ...
        <div className="project-card-left project-card">
          <div className="project-card-inner">
            <img
              className="project-img left-img"
              src={
                process.env.PUBLIC_URL + "/project_imgs/cnn_movie_reviews.webp"
              }
              alt="The CNN"
            />
            <video
        ...
        <div className="project-card-left project-card">
          <div className="project-card-inner">
            <img
              className="project-img left-img"
              src={process.env.PUBLIC_URL + "/project_imgs/clip.webp"}
        ...
        <div className="project-card">
          <img
            className="project-img left-img"
            src={process.env.PUBLIC_URL + "/project_imgs/dep_tree.webp"}
        ...
        <div className="project-card">
          <img
            className="project-img top-img"
            src={process.env.PUBLIC_URL + "/project_imgs/word_embeddings.webp"}
      ...
      <div className="project-section" id="other-projects">
        ...
        <div className="project-card">
          <img
            className="project-img top-img"
            src={process.env.PUBLIC_URL + "/project_imgs/weather_app.webp"}
            style={{ width: "10rem" }}
